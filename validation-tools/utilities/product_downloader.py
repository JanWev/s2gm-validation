...
def main(TOKEN, GRANULE_LIST, RANDOMIZE, START, RUNNING, FINISHED, DOWNLOAD_FOLDER):
    token, userid, request_id = make_request(TOKEN)
    check_processing_status(token, userid, request_id)
    downloader(START, RUNNING, FINISHED, DOWNLOAD_FOLDER, request_id, token)

if __name__ == '__main__':
    main(TOKEN, GRANULE_LIST, RANDOMIZE, START, RUNNING, FINISHED, DOWNLOAD_FOLDER)